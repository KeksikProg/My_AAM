...
def build_func(center_base_shape, bland_shapes, mean_texture, appearance_deltas, 
               triangles, pixel_triangle_ids, pixel_bary_coords, 
    ...
    warp_coords_sym = symbolic_warp(shape_params_sym, center_base_shape, bland_shapes, triangles, pixel_triangle_ids, pixel_bary_coords)
    ...
    texture_current_sym = mean_texture_ca + appearance_deltas_ca @ app_params_sym
